...
import io.github.hansi132.discordfab.discordbot.api.command.exception.BotCommandException;
import io.github.hansi132.discordfab.discordbot.api.text.Messages;
...
import io.github.hansi132.discordfab.discordbot.commands.*;
...
public class CommandManager {
    private static final MainConfig CONFIG = JDiscordFab.getInstance().getConfig();
    private static final Logger LOGGER = LogManager.getLogger(JDiscordFab.class);
...
//        this.register(new AvatarCommand(CommandCategory.UTILITY, "avatar"));
    ...
    public void execute(@NotNull final BotCommandSource src, @NotNull final String input) {
        ...
        try {
            ...
            if (JDiscordFab.getInstance().isDevelopment()) {
